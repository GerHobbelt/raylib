...
int main(void)
{
    ...
    while (!RL_WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        RL_BeginDrawing();
            ...
            // Draw GUI controls
            //------------------------------------------------------------------------------
            GuiSliderBar((RL_Rectangle){ 600, 40, 120, 20 }, "StartAngle", NULL, &startAngle, -450, 450);
            GuiSliderBar((RL_Rectangle){ 600, 70, 120, 20 }, "EndAngle", NULL, &endAngle, -450, 450);

            GuiSliderBar((RL_Rectangle){ 600, 140, 120, 20 }, "InnerRadius", NULL, &innerRadius, 0, 100);
            GuiSliderBar((RL_Rectangle){ 600, 170, 120, 20 }, "OuterRadius", NULL, &outerRadius, 0, 200);

            GuiSliderBar((RL_Rectangle){ 600, 240, 120, 20 }, "Segments", NULL, &segments, 0, 100);
